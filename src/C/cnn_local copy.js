    ...
    <div>
        ...
        <div>
            ...
            <strong v-if="force || errata">네이버 오타<span style="color:red"> {{force}}{{errata}}</span>로 검색 </strong>
                ...
                <div id="dealtype" :class="v.link.type + ' ' + v.salePriceSuffix + ' ' + v.link.value + ' 삭제예정id'" v-for="(v,i) in info1" :key="v.link.value">
        ...
        <!-- @@@@@@@@@@@@@@@ -->
        <div id="checkarea">
            <div id="dealtype" :class="v.link.type + ' ' + v.salePriceSuffix + ' ' + v.link.value" v-for="(v,i) in info2" :key="v.link.value">
